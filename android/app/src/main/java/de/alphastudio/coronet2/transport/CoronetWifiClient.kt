...
fun parseSettings(json: JSONObject, previous: DeviceSettings = DeviceSettings()): DeviceSettings = previous.copy(
    ...
    ledLegacyAnimations = json.optBoolean("ledLegacyAnimations", previous.ledLegacyAnimations),
    ...
    ledLegacyAnimation = json.optIntList("ledLegacyAnimation", previous.ledLegacyAnimation),
