...
static constexpr TimeZoneOption TimeZoneOptions[] = {
    ...
    {"SAO PAULO / SANTIAGO", "UTC-3", "BRT3"},
    {"BUENOS AIRES", "UTC-3", "<-03>3"},
    {"NEW YORK / TORONTO", "UTC-5/-4", "EST5EDT,M3.2.0,M11.1.0"},
    {"CHICAGO / MEXICO", "UTC-6/-5", "CST6CDT,M3.2.0,M11.1.0"},
    {"DENVER / PHOENIX", "UTC-7/-6", "MST7MDT,M3.2.0,M11.1.0"},
