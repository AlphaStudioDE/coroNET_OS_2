...
static lv_disp_t *bsp_display_lcd_init(const bsp_display_cfg_t *cfg)
{
    ...
    */
    ...
    lvgl_port_display_cfg_t disp_cfg = {
        ...
        .hres = hres,
        .vres = vres,
        /* trans_size: BSP hint for the small LCD transfer window.
         * lv_port.c overrides this to hres*16 when the PSRAM canvas path is
         * active. The LVGL draw buffer stays in PSRAM; only the two transfer
         * windows need DMA-capable RAM. */
        .trans_size = hres * 8,
