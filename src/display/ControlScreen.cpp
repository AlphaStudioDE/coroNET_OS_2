...
uint32_t rgbwHex(const RgbwColor& color) {
    const uint8_t r = static_cast<uint8_t>(min(255U, static_cast<unsigned>(color.r) + color.w));
    const uint8_t g = static_cast<uint8_t>(min(255U, static_cast<unsigned>(color.g) + color.w));
    const uint8_t b = static_cast<uint8_t>(min(255U, static_cast<unsigned>(color.b) + color.w));
